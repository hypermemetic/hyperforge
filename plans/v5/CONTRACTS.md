...
| # | Decision                                                                                                                                                                                                |
|---|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| D1 | v5 daemon default port is **44104** (v5 became canonical hyperforge in 5.0.0 / V5PARITY-32; v4 retired to `hyperforge-legacy`). v5 registers in the Plexus registry as **`lforge`** — normalization pulled forward from 6.0.0 once v4 was no longer the default; the v4 binary now registers as `lforge-deprecated` for the remaining migration window. |
