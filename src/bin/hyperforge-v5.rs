//! hyperforge-v5 — v5 daemon binary.
//!
//! Listens on `--port` (default 44105, pinned in CONTRACTS D1), registers
//! a Plexus `DynamicHub` namespaced as `lforge-v5` (D1), and serves
//! `HyperforgeHub` over WebSocket JSON-RPC. Lives alongside v4.
...
/// CLI arguments for the v5 daemon.
#[derive(Parser, Debug)]
#[command(name = "hyperforge-v5")]
#[command(about = "Hyperforge v5 daemon — WebSocket JSON-RPC on --port")]
struct Args {
    /// Port for the WebSocket server. Defaults to 44105 (v5; v4 keeps 44104).
